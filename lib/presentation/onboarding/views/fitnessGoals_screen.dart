      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Lottie.asset(
                Assets.fitnessGoalsImage, // You can change this to a fitness-specific image
                height: 250,
                width: 350,
                fit: BoxFit.fitWidth,
              ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: selectedGoal == TextHelper.weightGain 
                              ? ColorHelper.secondaryColor.withAlpha((0.1 * 255).round())
                              : ColorHelper.backgroundColor,
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: selectedGoal == TextHelper.weightGain 
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    TextHelper.stayFitAndMaintainCurrentWeight,
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey[600],
                                    ),
                    ...
                    child: onboardingButton(
                      ...
                      onPressed: () async{
                        if (selectedGoal != null) {
                          ...
                          await SharedPreferenceHelper.setFitnessGoal(selectedGoal!);
                        }
                        navigateToScreen(Routes.dashboardScreen, replaceStack: false);
                      },
                    ),
                  ),
                ],
